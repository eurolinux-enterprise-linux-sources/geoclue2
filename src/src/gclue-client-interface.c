...
static const _ExtendedGDBusMethodInfo * const _gclue_dbus_client_method_info_pointers[] =
{
  &_gclue_dbus_client_method_info_start,
  &_gclue_dbus_client_method_info_stop,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _gclue_dbus_client_signal_info_location_updated_ARG_pointers[] =
{
  &_gclue_dbus_client_signal_info_location_updated_ARG_old,
  &_gclue_dbus_client_signal_info_location_updated_ARG_new,
  NULL
};
...
static const _ExtendedGDBusSignalInfo * const _gclue_dbus_client_signal_info_pointers[] =
{
  &_gclue_dbus_client_signal_info_location_updated,
  NULL
};
...
static const _ExtendedGDBusPropertyInfo * const _gclue_dbus_client_property_info_pointers[] =
{
  &_gclue_dbus_client_property_info_location,
  &_gclue_dbus_client_property_info_distance_threshold,
  &_gclue_dbus_client_property_info_time_threshold,
  &_gclue_dbus_client_property_info_desktop_id,
  &_gclue_dbus_client_property_info_requested_accuracy_level,
  &_gclue_dbus_client_property_info_active,
  NULL
};
 ...
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gclue_dbus_client_dup_location() if on another thread.</warning>
 *
 ...
 * Since this D-Bus property is both readable and writable, it is meaningful to use this function on both the client- and service-side.
 *
 * <warning>The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gclue_dbus_client_dup_desktop_id() if on another thread.</warning>
 *
 * Returns: (transfer none): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = _gclue_dbus_client_property_info_pointers[prop_id - 1];
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _gclue_dbus_client_schedule_emit_changed (skeleton, _gclue_dbus_client_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
